...
export { default as TimeServiceBar } from "./TimeServiceBar";

export { default as FirstChart } from "./charts/FirstChart";
export { default as SecondChart } from "./charts/SecondChart";
export { default as ThirdChart } from "./charts/ThirdChart";

export { default as LeftSide } from "./sideBar/LeftSide";
...
export { default as ZoomInBar } from "./sideBar/ZoomInBar";
